...
6. 每道菜都要给做法：先一句话点出关键（note），再给三步家常做法（steps），
   火候、时间、下锅顺序要写清楚，让不常下厨的老人照着也能做出来。
  ...
  "meals": [
    {
      "meal": "午餐",
      "dishes": [
        {"name": "菜名", "category": "荤菜", "ingredients": ["食材1", "食材2"], "spicy": 0,
         "note": "一句话做法要点，20 字以内",
         "steps": "①第一步 ②第二步 ③第三步，每步 15 字以内，家常做法即可"}
      ],
      "soup": "汤名，没有则空字符串",
      "staple": "主食",
...
- dishes 数量必须严格等于要求数量。
- steps 必须写成 ①②③ 连写的一行，给家里老人照着做用，步骤要具体（火候、时间、顺序），不要写「适量」。"""
